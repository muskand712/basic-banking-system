...
?>
        ...
        <h1 class="text-center pt-4" style="color:Black; background-color:rgba(76, 175, 80, 0.3);">CREATE A USER</h1>
        <br>

  <div class="background ">
  <div class="container" style="background-color: white;" >
    <div class="screen" style="background: white;">
      <div class="screen-header" style="background:white;">
      ...
      <div class="screen-body">
        <div class="screen-body-item left">
          <img class="img-fluid" src="img/bb.jpg" style="border: none; border-radius: 1% ;display: block;margin-left: auto;margin-right:auto;width: 40%;">
        </div>
...
<footer class="text-center mt-5 py-2" style="background-color : lavender;">
            <p>&copy 2021 Made by <b>MUSKAN DEWANGAN</b></p>
</footer>
